  ...
  public MovieDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMovieEntity = new EntityInsertionAdapter<MovieEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `movies` (`id`,`title`,`overview`,`posterUrl`,`backdropUrl`,`rating`,`category`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      public List<MovieEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new MovieEntity(_tmpId,_tmpTitle,_tmpOverview,_tmpPosterUrl,_tmpBackdropUrl,_tmpRating,_tmpCategory);
            _result.add(_item);
          }
          if (_result == null) {
